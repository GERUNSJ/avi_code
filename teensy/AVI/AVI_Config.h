...
#define M2_PORC_BAJO 20 // Porcentaje del Maximo que se considera Bajo
#define M2_PORC_MEDIO 25 // Porcentaje del Maximo que se considera Medio
#define M2_PORC_ALTO 35 // Porcentaje del Maximo que se considera Alto
